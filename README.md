...
### Prerequisites
Ensure you have **Python 3.8+** installed along with `pip`. This simulator is highly optimized for multi-threaded modern CPU architectures (e.g., AMD Ryzen 9 / Intel Core i9) with high-bandwidth memory arrays.
...
```
The interactive control panel will automatically launch in your default web browser (Edge/Chrome/Firefox).
